 ...
 */
public enum ZhsVirtualControllerClassContext {
    instance;
    ...
    public ZhsVirtualControllerClassContext setConfigGlobalAuthority(ConfigGlobalAuthority configGlobalAuthority) {
